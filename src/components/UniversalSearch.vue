    ...
    <div class="search-box">
      ...
      <button class="search-button" @click="handleSearch" title="搜索">
        <span class="search-icon">
          <svg t="1765516147484" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13936" width="32" height="32"><path d="M917.1 863.88L702.95 649.73c46.48-58.1 74.26-131.79 74.26-211.98 0-187.55-152.04-339.6-339.6-339.6C250.05 98.15 98 250.2 98 437.76s152.05 339.6 339.6 339.6c80.18 0 153.88-27.79 211.98-74.27l214.15 214.15c7.37 7.37 17.02 11.06 26.68 11.06s19.32-3.68 26.69-11.06c14.73-14.73 14.73-38.63 0-53.36zM437.61 701.89c-145.88 0-264.14-118.26-264.14-264.14s118.26-264.14 264.14-264.14c145.89 0 264.14 118.26 264.14 264.14S583.49 701.89 437.61 701.89z" fill="#ffffff" p-id="13937"></path></svg>
        </span>
      </button>
